 ...
 */
package com.example.android.weathercast.app;
...
public class TestFetchWeatherTask extends AndroidTestCase{
    ...
    public void testAddLocation(){} /*{
        ...
        System.out.println("-----------"+WeatherContract.LocationEntry.CONTENT_URI);
        System.out.println("-----------"+WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING);
